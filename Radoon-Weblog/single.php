...
if ($conn) {
    session_start();
    $post_id = $_GET['id'];
    $post = mysqli_fetch_all(mysqli_query($conn, "SELECT * FROM post WHERE id = '$post_id'"));
        ...
        <div class="col-md-3">
            <div class="sidebar">
                ...
                <div class="category-sidebar">
                    ...
                    <ul>
                        <li><a href="http://localhost/radoon-weblog/category/jenaei.php">جنایی</a></li>
                        <li><a href="http://localhost/radoon-weblog/category/math.php">ریاضی</a></li>
                        <li><a href="http://localhost/radoon-weblog/category/testhoosh.php">تست هوش</a></li>
                        <li><a href="http://localhost/radoon-weblog/category/sudoko.php">سودوکو</a></li>
                        <li><a href="http://localhost/radoon-weblog/category/chistan.php">چیستان</a></li>
                        <li><a href="http://localhost/radoon-weblog/category/mafhoumi.php">مفهومی</a></li>
                    </ul>
                </div>
            ...
            <div class="col-md-12">
                <div class="single-content">
                    ...
                    <div class="single-meta">
                        <ul>
<!--                            <li><a href="#" title="98/6/21" data-toggle="tooltip"><i class="fa fa-calendar-o"></i></a>-->
<!--                            </li>-->
<!--                            <li><a href="#" title="98/8/8" data-toggle="tooltip"><i class="fa fa-reply"></i></a></li>-->
                            <li><a title="<?=$user[0][1]?>" data-toggle="tooltip"><i class="fa fa-user-o"></i></a>
                            </li>
                            <li><a href="http://localhost/radoon-weblog/category/<?=$post[0][5] . '.php'?>" title="<?= $post[0][5] ?>" data-toggle="tooltip"><i class="fa fa-bars"></i></a>
                            </li>
<!--                            <li><a href="#" title="اشتراک در توئیتر" data-toggle="tooltip"><i class="fa fa-twitter"></i></a>-->
<!--                            </li>-->
