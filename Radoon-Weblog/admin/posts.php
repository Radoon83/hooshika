...
if ($conn) {
    $posts = mysqli_fetch_all(mysqli_query($conn, "SELECT * FROM post"));
}
?>
<div class="main-menu">
    <div class="container">
        <ul>
            <li><a href="userDashboard.html">داشبورد</a></li>
            <li><a href="../index.php">صفحه اصلی</a></li>
            <li><a href="../category.html">دسته بندی</a></li>
            <li><a href="posts.php">لیست مطالب</a></li>
        ...
        foreach ($posts as $item) {
            ...
            if ($item[6] == 0) {
                ...
                <div class="col-md-4">
                    ...
                    <a href="../controllers/adminControllers.php/?id=<?= $item[0]?>&req=deny" class="btn btn-danger">رد کردن</a>
                    <a href="../controllers/adminControllers.php/?id=<?= $item[0]?>&req=allow" class="btn btn-success">تایید کردن</a>
                </div>
            <?php }
        } ?>
